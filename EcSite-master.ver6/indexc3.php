...
<body>
  ...
  <div class="outer">
    ...
    <div class="list-outer">
      <ul class="list">
        <li class="list-item"><a href="index.php">Category1</a></li>
        <li class="list-item"><a href="indexc2.php">Category2</a></li>
        <li class="list-item current"><a href="indexc3.php">Category3</a></li>
        <li class="list-item"><a href="indexc4.php">Category4</a></li>
        <li class="list-item"><a href="indexc5.php">Category5</a></li>
      </ul>
    </div>
    <!--end メインカテゴリー-->
    ...
    <div class="wrapper wrapper-main flex-parent">
      ...
      <aside class="sidebar">
        <!--form-->
        <div class="widget">
          <form action="indexc3.php" method="post" class="search-form">
            <div>
              <input type="text" placeholder="アイテムを探す" class="search-box" name="search_value">
        ...
        <div class="widget">
          ...
          <li class="category-item"><a href="index.php">Category1</a></li>
            <li class="category-item"><a href="indexc2.php">Category2</a></li>
            <li class="category-item"><a href="indexc3.php">Category3</a></li>
            <li class="category-item"><a href="indexc4.php">Category4</a></li>
            <li class="category-item"><a href="indexc5.php">Category5</a></li>
          </ul>
        </div>
        <!--end category-->
      </aside>
  ...
  <div class="item">
        <a href="./cms/item_list.php">→商品編集画面へ</a>
  </div>
  <div class="item">
