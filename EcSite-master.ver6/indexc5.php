  ...
  <div class="outer">
    ...
    <div class="list-outer">
      <ul class="list">
        ...
        <li class="list-item"><a href="indexc3.php">Category3</a></li>
        <li class="list-item"><a href="indexc4.php">Category4</a></li>
        <li class="list-item current"><a href="indexc5.php">Category5</a></li>
      </ul>
    </div>
    <!--end メインカテゴリー-->
    ...
    <div class="wrapper wrapper-main flex-parent">
      ...
      <aside class="sidebar">
        <!--form-->
        <div class="widget">
          <form action="indexc5.php" method="post" class="search-form">
            <div>
